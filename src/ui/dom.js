...
export function createDOM() {
  ...
  fearTrack: document.getElementById("fearTrack"),
  fearFloat: document.getElementById("fearFloat"),
  ...
  diaryOverlay: document.getElementById("diaryOverlay"),
  ...
  storyDual: document.getElementById("storyDual"),
  storyIllusion: document.getElementById("storyIllusion"),
  storyReality: document.getElementById("storyReality"),
